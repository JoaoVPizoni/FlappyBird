...
#atribuindo imagens as variáveis do game
IMAGEM_CANO=pygame.transform.scale2x(pygame.image.load(os.path.join('imgs','pipe.png')))
IMAGEM_CHAO=pygame.transform.scale2x(pygame.image.load(os.path.join('imgs','base.png')))
IMAGEM_BACGROUND=pygame.transform.scale2x(pygame.image.load(os.path.join('imgs','bg.png')))
IMAGENS_PASSARO=[
...
#iniciando a fonte do game
pygame.font.init()

#atribuindo a fonte ao game - Arial (50)
FONTE_PONTOS=pygame.font.SysFont('arial',50)

#criando as classes do game
...
class Passaro:
    ...
    def desenhar(self, tela):
        ...
        #Definindo imagem quando passáro cai
    ...
    #Função que serve para identificar o pixel do passáro que encosta no cano (se encostar)
